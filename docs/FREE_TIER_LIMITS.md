...
| Image/video generation | Gemini Veo MCP (mock mode free) | Google Gemini Veo API |
...
| Google Gemini Veo API | Photo-to-video generation | Usage-based (Google AI credits) |
