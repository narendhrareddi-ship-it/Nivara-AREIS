...
## Step 7: Gemini Veo Photo-to-Video (Phase 2)

See **[PHASE2_VEO.md](PHASE2_VEO.md)** for site photo upload and social video posting.
...
- [ ] Gemini Veo MCP `/health` shows configured or mock mode
